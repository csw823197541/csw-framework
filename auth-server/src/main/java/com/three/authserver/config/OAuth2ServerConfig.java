...
import com.three.authserver.myextends.MyRedisTokenStore;
...
public class OAuth2ServerConfig extends AuthorizationServerConfigurerAdapter {
     ...
     * 认证管理器
     *
     * @see WebSecurityConfig 的authenticationManagerBean()
     */
    @Autowired
...
//		endpoints.authorizationCodeServices(new JdbcAuthorizationCodeServices(dataSource));
     ...
     * 通过参数access_token.add-user-info控制<br>
     * 2018.07.13
     *
     * @param accessToken
...
//		clients.jdbc(dataSource);
     ...
     */
    @Value("${access_token.jwt-signing-key:csw}")
